                       ...
                       p4est_intersect_t intersect_fn)
{
  ...
  internal = p4est_transfer_search_begin (p4est, c, intersect_fn);

  return p4est_transfer_search_end (internal);
}

p4est_transfer_internal_t *
p4est_transfer_search_begin_ext (p4est_t *p4est, p4est_queries_context_t *c,
